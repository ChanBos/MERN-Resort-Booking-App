 ...
 * Utilizing Chai's expect assertion interface. Set the URL of the Landing page, as well as the Home page. Set a name and type for testing
 * purposes.
...
describe("Status Code", function (done) {
  it("Server gets room requests.", function () {
    fetch("http://localhost:8080/api/rooms/getall", function (res) {
      expect(res.statusCode).to.equal(200);
      done();
    });
  });
